...
define(["three", "util", "shaders", "BufferGeometry", "random", "band", "parametric", "ellipsoid"],
    (function(THREE, util, shaders, BufferGeometry, Random, Band, Parametric, Ellipsoid) {
        ...
        var Scene = function(renderer, width, height) {
            ...
            scope.t = 0.0;
            //perspectiveCamera(cameraöffnungswinkel, apectRatio, 0.1 = Anfang der Camera, 2000 = Tiefe der Camera)
